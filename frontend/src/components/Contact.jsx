...
export default function Contact() {
  return (
    <>
      <div className="mt-16 mb-11 max-w-6xl max-lg:max-w-5xl mx-auto bg-gradient-to-r from-[#60aebd] to-[#27A267] border border-gray-300 rounded-3xl">
        <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4  font-[sans-serif]">
          <div>
            ...
            <ul className="flex mt-12 space-x-4">
              <li className="bg-[#27A267] hover:bg-[#194b33] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
          ...
          <div className="p-6 bg-gray-100 rounded-lg">
            <p className="text-xl font-semibold text-gray-800">
              <Typewriter
                words={["Bizimle İletişime Geç !", "Get in Touch with Us !"]}
                loop={5}
                cursor
                cursorStyle="_"
                typeSpeed={70}
            ...
            <form className="mt-8 space-y-4">
              ...
              <button
                type="button"
                className="text-white bg-[#27A267] hover:bg-[#194b33] tracking-wide rounded-lg text-sm px-4 py-3 flex items-center justify-center w-full !mt-6">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16px"
                  height="16px"
